...
However, before performing this computation we must make an assumption as to how the free market revenues is distributed over the time spent in market.
...
We compute the yearly revenues like this:
...
```{r}
# TODO: This code needs to be explained in plain-text.
