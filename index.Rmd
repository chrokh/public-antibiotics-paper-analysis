...
sertkaya2014$discount_rate_priv <- rep(discount_rates,
                                       each=length(unique(sertkaya2014$phase)))
```
...
```{r, print-driveab-dist, echo=FALSE}
...
driveab2018$discount_rate_priv <- rep(discount_rates,
                                      each = length(unique(driveab2018$phase)))
```
