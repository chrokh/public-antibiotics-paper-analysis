...
tmp %>%
  ...
  geom_contour(binwidth=25, size=0.25, color='black', linetype='solid', alpha=0.3) +
  geom_point(data = f, aes(publ_inefficiency, pred_go), size=0.5) +
...
tmp %>%
  ...
  facet_grid(src ~ prize_phase) +
  geom_raster(interpolate=TRUE) +
  geom_contour(binwidth=500,
               size=0.25, color='black', linetype='solid', alpha=0.3) +
  geom_point(data = f, aes(publ_inefficiency, pred_go), size=0.5) +
  geom_smooth(data = f, aes(publ_inefficiency, pred_go),
              color = 'black', size = 0.5,
              se = FALSE,
