...
# alias
dist <- sertkaya2014_phase_dist %>% arrange(indication, phase)
...
We then merge the development sample with the market sample into a single Sertkaya sample.
...
Since the Sertkaya data was expressed in millions of USD, percentages, and months we will normalize the sample into USD, fractions, and years respectively.
...
Finally we will sample developer discount rates and add it to our Sertkaya sample.
