...
log10_sample <- function (n, magnitude_min, magnitude_max)
  10^runif(n, magnitude_min, magnitude_max)
...
additional <- additional %>%
  mutate(prize_size = log10_sample(n(), magn_min, magn_max))
```
