...
Note that much of the code that is used to generate this analysis is not rendered into the final output (html) document.
...
These minor points of differentiation are outlined as comments in the code chunk below.
...
```{r, print-sertkaya-dist, results='asis'}
