...
We begin by loading external libraries, setting basic document options, and setting the seed for the randomizer.
...
Let us then set `N` to the number of samples that we want per data set.
